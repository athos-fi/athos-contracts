 ...
 *
 * @dev Exactly the same as `LnRewardSystem` except `PERIOD_LENGTH` and `STAKING_REWARD_LOCK_PERIOD`
 * for use in internal development environment.
 */
contract MockRewardSystem is OwnableUpgradeable {
