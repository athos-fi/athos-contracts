...
contract RewardLockerV2 is IRewardLocker, OwnableUpgradeable {
    ...
    function _unlockReward(address user, uint256 rewardEntryId) private {
        ...
        require(block.timestamp >= rewardEntry.unlockTime + 52 weeks, "RewardLocker: Unlock time not reached");
